...
public:
    ...
    float SkyboxVertices[180] = {
       ...
       // roof
        ...
        -25.0f,  0.0f,  -25.0f,     0.25f, 0.0f,
         25.0f,  0.0f,  -25.0f,     0.50f, 0.0f,
         25.0f,  0.0f,   25.0f,     0.75f, 0.0f,
        -25.0f,  0.0f,   25.0f,     1.0f, 0.0f,

        -25.0f,  25.0f,   25.0f,     0.0f, 1.0f,
        -25.0f,  25.0f,  -25.0f,     0.25f, 1.0f,
         25.0f,  25.0f,  -25.0f,     0.50f, 1.0f,
         25.0f,  25.0f,   25.0f,     0.75f, 1.0f,
        -25.0f,  25.0f,   25.0f,     1.0f, 1.0f,
