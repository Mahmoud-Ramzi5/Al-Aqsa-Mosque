...
public:
    ...
    float SkyboxVertices[176] = {
       ...
       // roof
        ...
        // sides
        -50.0f,  0.0f,   50.0f,   0.0f, 1.0f, 0.0f,    0.0f, 0.25f,
        -50.0f,  0.0f,  -50.0f,   0.0f, 1.0f, 0.0f,   0.25f, 0.25f,
         50.0f,  0.0f,  -50.0f,   0.0f, 1.0f, 0.0f,   0.50f, 0.25f,
         50.0f,  0.0f,   50.0f,   0.0f, 1.0f, 0.0f,   0.75f, 0.25f,
        -50.0f,  0.0f,   50.0f,   0.0f, 1.0f, 0.0f,   1.0f, 0.25f,
